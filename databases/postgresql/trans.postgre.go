...
func (db *postgreDB)CheckItems(req cModels.ReqTransItem)(models.Items,error){
	reqDB:=models.Items{}
	err:=db.postgre.Select("merchant_items.ID, merchant_items.name as item_name, merchant_items.type, merchant_items.price, merchant_discounts.percentage, merchant_discounts.name as discount_name").
